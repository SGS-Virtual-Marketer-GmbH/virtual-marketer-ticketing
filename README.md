# Welcome to Virtual Marketer Ticketing
...
Virtual Marketer Ticketing is your Swiss Army knife - a web-based helpdesk and customer support
platform packed with features to streamline customer communication across channels like email,
chat, telephone and social media.

## Built on Zammad

Virtual Marketer Ticketing is a rebranded deployment of [Zammad](https://github.com/zammad/zammad),
an open-source helpdesk platform created by the [Zammad Foundation](https://zammad-foundation.org/).
It is used here under the terms of the GNU AGPLv3 license; see [NOTICE.md](NOTICE.md) and
